...
const AddForm = useForm({
    bukti: null,
    tanggal: props.data_donatur.tanggal,
    donatur_id: props.data_donatur.donatur_id,
    nama_donatur: props.data_donatur.nama_donatur,
    jenis: props.data_donatur.jenis,
    jumlah: props.data_donatur.jumlah,
    ket: props.data_donatur.ket,
})
...
<template>
    <AuthenticatedLayout>
        ...
        <section class="py-3 flex justify-center w-full">
            <div class="max-w-2xl">
                <form @submit.prevent="submit" class="w-full block gap-7 bg-white px-4 py-3 rounded-lg shadow-md">
                    ...
                    <div class="w-full mb-2">
                        ...
                        <select id="countries" v-model="AddForm.donatur_id" @input="DonaturSelected($event)"
