...
function deleteJadwal() {
    FormDelete.delete(route('Kajian.delete'),{
        onSuccess:()=>{
            modalDelete.value=false;
            FormDelete.reset()
        }
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Jadwal Kajian</h2>
            <FlashMessage />
        </template>
                                            ...
                                            <Dropdown align="top" width="48">
                                                ...
                                                <template #content>
                                                    <DropdownLink class="bg-green-500 hover:bg-green-600 active:bg-green-400 text-white"
                                                        :href="route('Kajian.edit', { waktu: item.waktu, slug: item.id, Kajian: item.Kajian, })">
                                                        Edit </DropdownLink>
